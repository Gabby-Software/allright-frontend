...
import { PlusIcon } from '../../assets/media/icons'
...
export default function ProfileBodyEdit({
  ...
  //   const _defaultAdd: number = addresses.indexOf(
  //     addresses.find((address) => address.is_default) as AddressType
  //   )
  //   const [addresses, setAddress] = useState(values.addresses)

  //   useEffect(() => {
  //     // setFieldValue(`${addresses[defaultAddress].is_default}`, true)
            ...
            onClick={() => {
              const newAddresses = [
                ...values.addresses,
                {
                  ...
                  country: {
                    id:
                      values.addresses[0].country.id + values.addresses.length,
                    code: '',
                    is_active: false,
                    name_english: '',
                    name_local: ''
        ...
        <Card>
          ...
          <div className="profile__grid">
            <div className="profile__grid-item">
              ...
              {/* <FormPassword name="password" onUpdate={} /> */}
            </div>
          </div>
        </Card>
      </div>
