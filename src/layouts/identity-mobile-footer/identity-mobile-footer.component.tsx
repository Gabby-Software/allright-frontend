...
const IdentityMobileFooter = () => {
    ...
    return (
        <Styles>
            <div className={'footer__copyright'}>{t('footer.copyright', {year: new Date().getFullYear(), name: config.name})}</div>
            <div className={'footer__links'}>
                <Link className={'footer__link'} to={'/support'}>{t('footer.tnb')}</Link>
                <Link className={'footer__link'} to={'/tnb'}>{t('footer.support')}</Link>
